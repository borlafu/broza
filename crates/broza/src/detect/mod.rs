...
//! narrows the result to what `suggest` asked for, and the private `overlap`
//! pass credits a path claimed by two findings to one of them. Nothing here writes: a finding
